...
public class MultigetSliceResult implements org.apache.thrift.TBase<MultigetSliceResult, MultigetSliceResult._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift.protocol.TField LST_FIELD_DESC = new org.apache.thrift.protocol.TField("lst", org.apache.thrift.protocol.TType.I64, (short)3);

  public Map<ByteBuffer,List<ColumnOrSuperColumn>> value; // required
  public long lts; // required
  public long lst; // required
  ...
  private static final int __LST_ISSET_ID = 1;
...
;
  ...
  public MultigetSliceResult setLst(long lst) {
    this.lst = lst;
    setLstIsSet(true);
    return this;
  }
  ...
  public boolean equals(MultigetSliceResult that) {
    ...
    boolean this_present_lst = true;
    boolean that_present_lst = true;
    if (this_present_lst || that_present_lst) {
      if (!(this_present_lst && that_present_lst))
        return false;
      if (this.lst != that.lst)
        return false;
    }
  ...
  public int compareTo(MultigetSliceResult other) {
    ...
    lastComparison = Boolean.valueOf(isSetLst()).compareTo(typedOther.isSetLst());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLst()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.lst, typedOther.lst);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
