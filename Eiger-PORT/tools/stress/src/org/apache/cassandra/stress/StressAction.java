...
public class StressAction extends Thread
{
	...
	if (client.getKeys_per_read() != 0) {
            ...
            this.key_sets_size = 5000000; // for population, does not matter
        }
    }
 ...
 output.println("pre-genrating keys is done!!!"); 
	...
	if (latencies.length == 0) {
        ...
        System.err.println(String.format("Overall Latencies (usecs): 50=%d, 75=%d, 90=%d, 95=%d, 99=%d, 99.9=%d",
                percentile(latencies, 50), percentile(latencies, 75), percentile(latencies, 90), percentile(latencies, 95),
    ...
    // RO6 read latency
        ...
        System.err.println(String.format("Read Latencies (usecs): 50=%d, 75=%d, 90=%d, 95=%d, 99=%d, 99.9=%d",
                percentile(readlatencies, 50), percentile(readlatencies, 75), percentile(readlatencies, 90), percentile(readlatencies, 95),
...
//	System.err.println(String.format("List of Read Latencies: %s", Arrays.toString(readlatencies)));
        ...
        System.err.println(String.format("Write Latencies (usecs): 50=%d, 75=%d, 90=%d, 95=%d, 99=%d, 99.9=%d",
                percentile(writelatencies, 50), percentile(writelatencies, 75), percentile(writelatencies, 90), percentile(writelatencies, 95),
