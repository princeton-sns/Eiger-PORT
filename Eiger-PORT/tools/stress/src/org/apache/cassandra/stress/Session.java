...
public class Session implements Serializable
{
	...
	availableOptions.addOption("", "expandible-hops", true, "number of hops for expandible rotxn, 0 means no test on expandibility");
    }
    ...
    private int expandibleHop = 0;  // snow, expandibility
    // Khiem
    ...
    public Session(String[] arguments) throws IllegalArgumentException
    {
	    ...
	    if (cmd.hasOption("expandible-hops")) {
                expandibleHop = Integer.parseInt(cmd.getOptionValue("expandible-hops"));
            }
    ...
    // RO6: use zipfian
    public boolean useZipfianGenerator() { return useZipfian != 0 && zipfianConstant > 0.05; }
    ...
    public int getExpandibleHop() { return expandibleHop; }
