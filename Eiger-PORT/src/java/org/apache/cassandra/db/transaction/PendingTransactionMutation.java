...
public class PendingTransactionMutation extends RowMutation
{
    ...
    public void makePending(QueryPath path, ByteBuffer transactionCoordinatorKey)
    {
        Integer id = Schema.instance.getId(table_, path.columnFamilyName);
        ColumnFamily columnFamily = modifications_.get(id);
        if (columnFamily == null)
        ...
        columnFamily.addPendingTransactionColumn(path, transactionId, pendingTime, transactionCoordinatorKey);
    }
