...
public class RowMutationVerbHandler implements IVerbHandler
{
    ...
    public void doVerb(Message message, String id)
    {
        try
        {
            ...
            sendMutationResponse(message, id, rm);
            ...
            if (rm.getDependencies().size() > 0) {
                ...
                StorageProxy.checkGroupDependencies(rm.getTable(), rm.key(), rm.extractTimestamp(), rm.getDependencies(), new RowMutationCompletion(message, id, rm));
            } else {
    ...
    protected void sendMutationResponse(Message message, String id, RowMutation rm) throws IOException {
