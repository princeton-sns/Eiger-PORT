    ...
    public Column deserialize(DataInput dis, IColumnSerializer.Flag flag, int expireBefore) throws IOException {
        ...
        if ((b & COUNTER_MASK) != 0) {
            ...
            return (b & COUNTER_UPDATE_MASK) != 0
                    ...
                    ? new PendingTransactionColumn(name, value, ts, lastAccessTime, previousVersionLastAccessTime, earliestValidTime, latestValidTime, previousVersions, transactionCoordinatorKey, -1, -1)
                    : new Column(name, value, ts, lastAccessTime, previousVersionLastAccessTime, earliestValidTime, latestValidTime, previousVersions, transactionCoordinatorKey, -1, -1);
        }
    }
