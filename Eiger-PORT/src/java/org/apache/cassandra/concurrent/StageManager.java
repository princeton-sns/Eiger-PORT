...
public class StageManager
{
    ...
    static
    {
        ...
        stages.put(Stage.REQUEST_RESPONSE, multiThreadedConfigurableStage(Stage.REQUEST_RESPONSE, getConcurrentReplicators()));
        ...
        // separate stage for dependency check
        stages.put(Stage.DEPENDENCY_CHECK,  multiThreadedStageFixedPoolNoTimeout(Stage.DEPENDENCY_CHECK, getConcurrentReplicators()));
