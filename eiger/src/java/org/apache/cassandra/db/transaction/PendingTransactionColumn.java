...
public class PendingTransactionColumn extends Column
{
    ...
    public PendingTransactionColumn(ByteBuffer name, long transactionId, long pendingTime, ByteBuffer transactionCoordinatorKey) {
        this(name, ByteBufferUtil.bytes(transactionId), pendingTime, null, null, pendingTime, null, null, transactionCoordinatorKey);
    }
    ...
    public IColumn localCopy(ColumnFamilyStore cfs, Allocator allocator) {
        return new PendingTransactionColumn(cfs.internOrCopy(name, allocator), allocator.clone(value), timestamp, lastAccessTime, lastAccessTimeOfAPreviousVersion, earliestValidTime, latestValidTime, previousVersions, transactionCoordinatorKey);
    }
