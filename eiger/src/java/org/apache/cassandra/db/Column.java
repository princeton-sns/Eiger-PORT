...
/*
            ...
            while (prevVersionIt.hasNext()) {
                ...
                if (prevVersion.lastAccessTimeOfAPreviousVersion() == null || prevVersion.lastAccessTimeOfAPreviousVersion() < safeTime) {
...
/*
        ...
        if ((previousColumn.lastAccessTimeOfAPreviousVersion != null && previousColumn.lastAccessTimeOfAPreviousVersion >= safeTime) ||
                (previousColumn.lastAccessTime != null && previousColumn.lastAccessTime >= safeTime)) {
