...
public class StorageService implements IEndpointStateChangeSubscriber, StorageServiceMBean
{
    ...
    public enum Verb
    {
        ...
        TRANSACTION_COHORT,
        // Khiem: new messages for remote reads
        READ_REMOTE,
        // KHIEM: for cache on remote read
        CACHE_ON_READ,
        GROUP_DEPENDENCY_CHECK,
        ;
    ...
    {{
        ...
        put(Verb.DEPENDENCY_CHECK, Stage.DEPENDENCY_CHECK); //Perhaps should be on Replicate_on_write, or it's own stage
        ...
        put(Verb.READ_REMOTE, Stage.READ); // Khiem: remote read
        put(Verb.GROUP_DEPENDENCY_CHECK, Stage.DEPENDENCY_CHECK);
    ...
    public StorageService()
    {
        ...
        MessagingService.instance().registerVerbHandlers(Verb.GROUP_DEPENDENCY_CHECK, new GroupDependencyCheckVerbHandler());

        // Khiem: add new types of message between datacenters here
        // TODO: registerVerbHandlers for READ_REMOTE
        //MessagingService.instance().registerVerbHandlers(Verb.READ_REMOTE, new RemoteReadVerbHandler());
